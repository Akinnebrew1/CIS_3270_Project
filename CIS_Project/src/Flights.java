...
import java.util.Scanner;
	...
	int passengerCount;//current # of passengers on a given flight
	int maxCapacity;// max # of passengers on a given flight
	...
	Flights(){
		...
		setArrivalDate();
		setArrivalTime();
		ArrayList<Users> passengerList = new ArrayList<Users>();//array list to store passengers on the flight
		passengerCount = 0;
		setMaxCapacity();
